  ...
  return (
    <div className="flex items-center justify-between py-5 px-2 md:py-5 md:px-14 lg:px-20 fixed bg-gray-700 top-0 z-50 w-full">
      ...
      <div className="flex items-center gap-2 md:gap-6">
        ...
        <section
          className={`flex flex-col items-center justify-center gap-20 bg-white p-12 pl-5 border border-gray-500 rounded-r-[2.8125rem] h-[45rem] z-10 absolute top-0 left-0 md:p-10 md:gap-24 ${
            isSideBarOpen
